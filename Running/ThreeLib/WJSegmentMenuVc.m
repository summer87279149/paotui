...
//  WJSegmentMeunVc
//
//  Created by 吴计强 on 16/4/4.
//  Copyright © 2016年 com.firsttruck. All rights reserved.
//


#define WJSegmentMenuVcDefaultSpace             0
#define WJSegmentMenuVcDefaulTag                960
#define WJSegmentMenuVcDefaulButtonW            40
...
#define WJSegmentMenuVcDefaultSelectedColor     [UIColor colorWithRed:241/244.0 green:23/244.0 blue:33/244.0 alpha:1.0]
#define WJSegmentMenuVcDefaultSlideColor        [UIColor colorWithRed:241/244.0 green:23/244.0 blue:33/244.0 alpha:1.0]
...
- (void)initScrollviewWithTitles:(NSArray *)titles{
    ...
    scrollView.contentSize = CGSizeMake((kSCREENWIDTH/4 + WJSegmentMenuVcDefaultSpace) * titles.count + WJSegmentMenuVcDefaultSpace, self.frame.size.height);
    ...
    for (int i = 0; i < titles.count; i ++) {
        UIButton *btn = [[UIButton alloc]initWithFrame:CGRectMake(WJSegmentMenuVcDefaultSpace + (kSCREENWIDTH/4 + WJSegmentMenuVcDefaultSpace) * i, WJSegmentMenuVcDefaultSpace, kSCREENWIDTH/4, self.frame.size.height - WJSegmentMenuVcDefaultSpace * 2)];
...
- (void)buttonMoveWithIndex:(NSInteger)clickIndex{
    [UIView animateWithDuration:0.24 animations:^{
        ...
        tempFrame.origin.x = WJSegmentMenuVcDefaultSpace + (kSCREENWIDTH/4 + WJSegmentMenuVcDefaultSpace) * clickIndex;
