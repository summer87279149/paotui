...
//    self.navigationController.navigationBar.tintColor = [UIColor jk_colorWithHexString:@"#FF2E89"];
    [[UINavigationBar appearance] setBarTintColor:[UIColor whiteColor]];
//    [[UINavigationBar appearance] setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor jk_colorWithHexString:@"#FF2E89"]}];
}
